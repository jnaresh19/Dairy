...
public class DairyEntriesDbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_QUERY =
            "CREATE TABLE "+
                    ...
                    DairyEntriesContract.DairyEntries.COLUMN_NAME_IMAGES + " TEXT);";
    ...
    public long insertDairyEntry(String title, String desc, String date , String images,SQLiteDatabase db)
    {
        ...
        contentValues.put(DairyEntriesContract.DairyEntries.COLUMN_NAME_IMAGES, images);
    ...
    public Cursor getAllDairyEntries(SQLiteDatabase db)
    {
        String[] projection = {
                ...
                DairyEntriesContract.DairyEntries.COLUMN_NAME_IMAGES
        };
